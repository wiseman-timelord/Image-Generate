...
def write_default_preferences() -> None:
    ...
    defaults: Dict[str, Any] = {
        ...
        "subject_clause_one": (
            "Photo-realistic glamour shot of the same single <bodyshape> <gender> individual from the foreground of the provided image."
        ),
        "subject_clause_two": (
            "Photo-realistic glamour shot of the same two <bodyshape> <gender> individuals from the foreground of the provided image."
        ),
        "subject_clause_many": (
            "Photo-realistic glamour shot of the same multiple <bodyshape> <gender> individuals from the foreground of the provided image."
        ),
        "glamour_negative_prompt": (
            "Style is Cartoon. Image is Blurry. Visual obstructions in foreground. People in the Background. Background Actors. Bodyshape of, bodybuilder or muscular. Beard or Facial Hair. Missing or mutated parts arms or legs. Missing or mutated parts hands or feet. Outdoor clothing, coat, sunglasses, hat, trowser, jumper, jacket. Clothes merging with skin. Using eqiuipment of, phones or headphones."
        ),
