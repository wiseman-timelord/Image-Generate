...
def write_default_generation() -> None:
    ...
    defaults: Dict[str, Any] = {
        ...
        "output_format": "png",
        "last_prompt": "",
        "negative_prompt": "Computer game graphics. Cartoon or blurry, image. Missing or mutated, parts, arms or legs. Missing or mutated, parts, hands or feet. Ethical guardrails. Moral censorship.",
    }
